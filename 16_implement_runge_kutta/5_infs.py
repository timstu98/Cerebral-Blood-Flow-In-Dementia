...
def RK4(i,network_row_main_updated,vessels_main_updated):
    ...
    # no need to update
    k1s , network_row_all_updated, vessels_all_updated = single_RK_run( i , network_row_main_updated , vessels_main_updated)
    ...
    vessels , network_row = update_v_n(k1s,0.5,vessels_all_updated,network_row)
    k2s , ignore_n, ignore_v= single_RK_run(i+0.5,network_row,vessels)

    vessels,network_row = update_v_n(k2s,0.5,vessels,network_row)
    k3s,ignore_n,ignore_v = single_RK_run(i+0.5,network_row,vessels)

    vessels,network_row = update_v_n(k3s,1,vessels,network_row)
...
def master(alpha,delay,baselines):
    ...
    for i in tqdm(range(len(t)-1)): #Could maybe itterrows this column now as simply saving?
        ...
        delta_values , network_row_all_updated, vessels_all_updated = RK4(i, network_row_main_updated, vessels_main_updated)
