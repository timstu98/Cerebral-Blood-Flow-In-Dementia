...
def plt_vessels(column_string,column_label,normal=False):
    ...
    if not normal:
        plt.plot(t[0:len(A1_data)],A1_data,linewidth=1,linestyle="-",color='blue',label='A1')
        ...
        plt.plot(t[0:len(A5_data)],A5_data,linewidth=1,linestyle="-",color='blue',label='A5')
        # plt.plot(t[0:len(A6_data)],A6_data,linewidth=1,linestyle="-",color='blue')
        plt.plot(t[0:len(C_data)],C_data,linewidth=1,linestyle="-",color='blue',label='C')
        # plt.plot(t[0:len(V6_data)],V6_data,linewidth=1,linestyle="-",color='blue')
        plt.plot(t[0:len(V5_data)],V5_data,linewidth=1,linestyle="-",color='blue',label='V5')
        ...
        plt.plot(t[0:len(V1_data)],V1_data,linewidth=1,linestyle="-",color='blue',label='V1')
    else:
