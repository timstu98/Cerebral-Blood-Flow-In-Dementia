...
network['norm R_tot'] = network['R_tot']/network.at[0,'R_tot']
...
plt_single('Q_norm', '$Q_[norm]$')
plt_single('phi','$\phi$')
plt_single('phi_min','$\phi_[min]$')
plt_single('norm R_tot','Normalsied R')
print('singles')
plt_triple('Ap','Vp','Dp','Proportion of pericytes\nin state')
plt_triple('An','Vn','Dn','Proportion of neurons\nin state')
print('doubles')
plt_base('c','c',0.909090909)
plt_base('pt_volume_averaged','$p_[t]$',44.113829801035656)
